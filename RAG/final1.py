...
# Step 6: Handle user input and display answers with page numbers
...
# Function to generate questions and answers from the summary using LLM
...
def main():
    ...
    # Button to toggle summary display
